...
return array(
	'ServerAddress'				=> 'http://www.gimano-ro.online/',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> '/',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> 'yazid97',		// Installer/updater password.
	...
	'SiteTitle'					=> 'Gimano Ragnarok Online',	// This value is only used if the theme decides to use it.
	'ThemeName'					=> array('purple_themes'), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
